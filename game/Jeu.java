...
public abstract class Jeu {
    ...
    EnvTextMap gameText;
    EditeurDico editeurDico;
    
    public Jeu() {

        // Crée un nouvel environnement
        env = new Env();
        editeurDico = new EditeurDico("src/xml/dico.xml");
        // Instancie une Room
        ...
        menuText.addText("Bon!\n"+"Tapez 1 pour continuer", "EN", 200, 300);
        ...
        do {
            ...
            switch (touche) {
                ...
                case Keyboard.KEY_1: // choisi un niveau et charge un mot depuis le dico
                    ...
                    String mot=dico.getMotDepuisListeNiveaux(n-1);
                    gameText = new EnvTextMap(env);
    ...
    private MENU_VAL menuPrincipal() {
        ...
        switch (touche) {
            ...
            case Keyboard.KEY_2:
                ...
                profil = new Profil(nomJoueur,"2000/05/21");
                choix = menuJeu();
                break;
            ...
            case Keyboard.KEY_5:
                ...
                editeurDico.ecrireDOM("src/xml/dico.xml");
                menuText.getText("EN").display();
                        int i=0;
                        while (!(i == Keyboard.KEY_1)) {
                            i = env.getKey();
                            env.advanceOneFrame();
    ...
    public void joue(Partie partie) {
        ...
        while (!finished) {
            ...
            //1 is for escape key
            if (fin()||partie.getPourcentageTrouve()==100) {
                finished = true;
            }
